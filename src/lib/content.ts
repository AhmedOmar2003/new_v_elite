...
export const en = {
  ...
  home: {
    title: "Creator campaigns built for your goal and ready to scale | ELITƎ",
    description:
      "ELITƎ coordinates creator campaigns at scale, tailored to each brand's goal and delivered through a simple Flat Rate model.",
    eyebrow: "Creator campaigns · 52+ countries",
    heroLine1: "Creator campaigns built for your goal.",
    heroLine2: "Ready to scale.",
    heroBody:
      "Activate the right creators as one coordinated campaign, tailored to your objective and delivered through a simple Flat Rate model.",
    ...
    whyEyebrow: "The ELITƎ model",
    whyLine1: "A clear model for creator campaigns",
    whyLine2: "at scale.",
    whyBody:
      "Every solution is tailored to your goal. BUZZ creates momentum; MAINTAIN keeps your brand present.",
    pillars: [
      {
        title: "Flat Rate",
        body: "A straightforward commercial model that makes creator campaigns easier to plan and scale.",
      },
      {
        title: "Tailored Solutions",
        body: "A campaign approach shaped around your brand, market, audience, and objective.",
      },
      {
        title: "BUZZ",
        body: "Activate many relevant creators in a focused push to build immediate visibility and momentum.",
      },
      {
        title: "MAINTAIN",
        body: "Keep your brand visible and relevant through consistent creator activity over time.",
      },
    ],
...
export const ar: Content = {
  ...
  home: {
    title: "حملات صُنّاع محتوى مصممة لهدفك وجاهزة للتوسع | ELITƎ",
    description:
      "تنسّق ELITƎ حملات صُنّاع المحتوى على نطاق واسع، بحلول مخصّصة لهدف كل علامة تجارية ونموذج Flat Rate بسيط.",
    eyebrow: "حملات صُنّاع المحتوى · أكثر من ٥٢ دولة",
    heroLine1: "حملات صُنّاع محتوى مصممة لهدفك.",
    heroLine2: "وجاهزة للتوسع.",
    heroBody:
      "فعّل صُنّاع المحتوى المناسبين ضمن حملة واحدة منسّقة، مخصّصة لهدفك وتُقدَّم وفق نموذج Flat Rate بسيط.",
    heroAlt: "ضيوف في عشاء خاص على سطح يطل على أفق مدينة خليجية",
    trusted: "تثق بنا علامات تجارية في الخليج وخارجه",
    whyEyebrow: "نموذج ELITƎ",
    whyLine1: "نموذج واضح لحملات صُنّاع المحتوى",
    whyLine2: "واسعة النطاق.",
    whyBody: "نخصّص كل حل لهدفك. يصنع BUZZ الزخم، بينما يحافظ MAINTAIN على حضور علامتك.",
    pillars: [
      {
        title: "Flat Rate",
        body: "نموذج تجاري مبسّط يجعل تخطيط حملات صُنّاع المحتوى وتوسيعها أسهل.",
      },
      {
        title: "حلول مخصّصة",
        body: "نهج للحملة مصمم حول علامتك وسوقك وجمهورك والهدف الذي تريد تحقيقه.",
      },
      {
        title: "BUZZ",
        body: "فعّل عددًا كبيرًا من صُنّاع المحتوى المناسبين خلال فترة مركّزة لبناء ظهور فوري وزخم قوي.",
      },
      {
        title: "MAINTAIN",
        body: "حافظ على حضور علامتك وارتباطها بالجمهور عبر نشاط مستمر لصُنّاع المحتوى مع مرور الوقت.",
      },
    ],
