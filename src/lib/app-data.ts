...
export const demoNotice = "Demo content shown for illustration only.";
...
export const dashboardStats = [
  ...
  { label: "Published content", value: "412", delta: "34%", dir: "up", foot: "items this month" },
...
export const attention = [
  {
    tone: "warn" as Tone,
    title: "4 creators are waiting for approval",
    meta: "Rüya Riyadh — Season Launch · Oldest request: 3 days",
  ...
  },
  {
    ...
    meta: "9 of 14 deliverables complete",
    to: "/app/campaigns" as const,
...
export const coverageTrend = [
  { x: "W1", label: "38 published items", value: 51 },
  { x: "W2", label: "44 published items", value: 59 },
  { x: "W3", label: "41 published items", value: 55 },
  { x: "W4", label: "57 published items", value: 77 },
  { x: "W5", label: "62 published items", value: 84 },
  { x: "W6", label: "51 published items", value: 69 },
  { x: "W7", label: "68 published items", value: 92 },
  { x: "W8", label: "74 published items", value: 100 },
] as const;
...
export const activity = [
  ...
  {
    icon: "megaphone",
    text: "**Coya Riyadh — Anniversary** closed at 118% of its published-content target",
...
export const campaignDetail = {
  ...
  alert: {
    title: "4 creators need your approval.",
    body: "The oldest request has been waiting 3 days. Approving them now keeps the visit schedule moving.",
  ...
  stats: [
    ...
    { label: "Creators", value: "24", foot: "18 complete · 6 in progress" },
    { label: "Estimated reach", value: "3.1M", delta: "18%", dir: "up", foot: "vs forecast" },
    {
      label: "Avg. cost per published item",
      value: "SAR 640",
      delta: "9%",
      dir: "down",
  ...
  brief: [
    ...
    ["Budget", "SAR 70,400"],
    ["Campaign owner", "Layla Al-Rashid"],
  ],
  manager: {
    name: "Ahmed Kassem",
    meta: "ELITƎ manager · replies in ~20 min",
...
export const reportTrend = [
  { x: "Mar", label: "52 published items", value: 59 },
  { x: "Apr", label: "61 published items", value: 69 },
  { x: "May", label: "48 published items", value: 55 },
  { x: "Jun", label: "74 published items", value: 84 },
  { x: "Jul", label: "69 published items", value: 78 },
  { x: "Aug", label: "88 published items", value: 100 },
] as const;
...
export const notificationPrefs = [
  ...
  { label: "New content published", on: true },
