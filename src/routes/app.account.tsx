  ...
  return (
    <>
      <PageHead
        ...
        title="Account"
        lede="Manage your profile, team access, notifications, and workspace settings."
      />
        ...
        <div className="grid content-start gap-5">
          ...
          <Panel id="team">
            <PanelHead
              ...
              sub={`${team.length} people have access to this workspace.`}
              actions={
          ...
          <Panel>
            ...
            <PanelBody className="grid gap-4">
              <p className="text-sm leading-relaxed text-muted-foreground">
                This is a demo workspace using sample data. Explore freely — the data resets when
                you reload.
              </p>
              <AppButton block onClick={() => demo("Demo data resets when you reload.")}>
                <RotateCcw className="size-4" /> Reset demo data
              </AppButton>
            </PanelBody>
            <PanelFoot>
              <ArrowLink to="/">Return to the ELITƎ website</ArrowLink>
            </PanelFoot>
          </Panel>
        </div>
      </div>
