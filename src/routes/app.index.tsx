  ...
  return (
    <>
      <PageHead
        ...
        lede="3 campaigns are live. 4 creator approvals need your attention."
        actions={
          <>
      ...
      <section className="mt-6 grid gap-5 lg:grid-cols-[1.6fr_1fr]">
        <Panel>
          <PanelHead
            ...
            sub="See every creator across your live campaigns by current stage."
            actions={<ArrowLink to="/app/campaigns">Explore all campaigns</ArrowLink>}
          />
          <PanelBody>
            <Pipeline
      ...
      <section className="mt-6 grid gap-5 lg:grid-cols-[1.6fr_1fr]">
        ...
        <Panel>
          <PanelHead
            title="Published content by format"
            sub={`${totalCoverage} items this month`}
          />
          <PanelBody>
            <Donut
