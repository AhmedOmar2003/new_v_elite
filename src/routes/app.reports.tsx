  ...
  return (
    <>
      <PageHead
        ...
        title="Reports"
        lede="See published content, estimated reach, and campaign costs in one place — ready to export and share."
        actions={
          <>
      ...
      <Panel className="mt-6">
        <PanelHead
          title="Published content over time"
      ...
      <section className="mt-6 grid gap-5 lg:grid-cols-[1.6fr_1fr]">
        <Panel>
          <PanelHead
            title="Top creators"
            sub="Ranked by published campaign content during the selected period"
          />
          <PanelBody flush>
            <TableWrap>
              <caption className="sr-only">Top creators by published campaign content</caption>
              <thead>
                <tr>
                  ...
                  <Th num>Estimated reach</Th>
                  <Th num>Engagement</Th>
                  <Th num>Avg. cost per published item</Th>
                </tr>
              </thead>
              <tbody>
                {rows.map((creator, i) => (
        ...
        <Panel>
          <PanelHead title="Published content by branch" />
          <PanelBody>
            <BarList
            ...
            <p className="mt-8 text-sm text-muted-foreground">
              Al Khobar is below the branch average, with 6 creators compared with an average of 14.
            </p>
          </PanelBody>
        </Panel>
      </section>
