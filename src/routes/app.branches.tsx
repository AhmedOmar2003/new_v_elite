  ...
  return (
    <>
      <PageHead
        ...
        title="Branches"
        lede="Track creator check-ins and campaign activity separately for every location in your group."
        actions={
      ...
      <Toolbar>
        <SearchField
          id="branch-search"
          label="Search branches or cities"
      ...
      {shown.length === 0 ? (
        ...
        <Panel>
          <PanelBody flush>
            <TableWrap>
              <caption className="sr-only">Campaign activity by branch</caption>
              <thead>
                <tr>
                  <SortHeader
                    label="Branch"
                  ...
                  />
                  <Th num>Reach</Th>
                  <Th>Share of published content</Th>
                  <Th>Status</Th>
                </tr>
              </thead>
              <tbody>
