      ...
      {authored ? (
        <>
          <Panel className="mt-6">
            <PanelHead
              ...
              sub="24 creators · See the current stage of every creator in this campaign."
            />
            <PanelBody>
              <Pipeline
          ...
          <section className="mt-6 grid gap-5 lg:grid-cols-[1.6fr_1fr]">
            <Panel id="roster">
              <PanelHead
                ...
                sub="Search or filter by stage to find a creator quickly."
              />
                                ...
                                {open && (
                                  ...
                                  >
                                    ...
                                    <RowAction
                                      ...
                                      onSelect={() => {
                                        setOpenRow(null);
                                        demo(`Opening published content for ${row.name}`);
                                      }}
                                    />
            ...
            <div className="grid content-start gap-5">
              <Panel>
                <PanelHead title="Published content by format" />
                <PanelBody>
        ...
        <Panel className="mt-6">
          <PanelBody>
            <EmptyState
              icon={<Info />}
              title="This demo campaign includes summary data only."
              body={`To explore the full creator pipeline, roster, and campaign brief, open “${authoredName}.”`}
