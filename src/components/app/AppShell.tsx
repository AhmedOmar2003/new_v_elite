...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/app/scanner", label: "Check-ins", icon: ScanLine },
    ],
  },
  { label: "Insights", items: [{ to: "/app/reports", label: "Reports", icon: BarChart3 }] },
] as const;
...
const titles: Record<string, string> = {
  "/app": "Dashboard",
  "/app/influencers": "Creators",
  "/app/campaigns": "Campaigns",
  "/app/branches": "Branches",
  "/app/scanner": "Creator check-ins",
  "/app/reports": "Reports",
  "/app/account": "Account",
};
      ...
      {open && (
        ...
        >
          ...
          <Link to="/" onClick={() => setOpen(false)} role="menuitem" className={item}>
            <Globe /> Return to the ELITƎ website
          </Link>
        </div>
      )}
      ...
      <div className="relative ms-auto hidden max-w-xs flex-1 md:block">
        ...
        >
          <span className="flex items-center gap-2">
            ...
            <span>Search campaigns and creators…</span>
          </span>
            ...
            <div className="float-surface absolute end-0 top-full mt-2 w-80 rounded-2xl border border-border bg-[color:var(--bg-raised)] p-4 shadow-xl">
              ...
              <div className="mt-3 flex flex-col gap-2.5">
                ...
                <Link
                  ...
                  className="rounded-lg p-2 transition-colors hover:bg-muted/50"
                >
                  <p className="text-xs font-semibold">17 new stories ready to verify</p>
                  <p className="text-[0.7rem] text-muted-foreground">
          ...
          <div className="w-full max-w-lg rounded-2xl border border-border bg-[color:var(--bg-raised)] p-4 shadow-2xl">
            <div className="flex items-center gap-3 border-b border-border pb-3">
              ...
              <input
                type="text"
                autoFocus
                placeholder="Search campaigns, creators, and reports…"
                value={searchQuery}
